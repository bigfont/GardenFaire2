(function () {
    ...
    // Geocoding done at http://www.findlatitudeandlongitude.com/batch-geocode/#.UYLOGMqrXTp
    locations = [
        ...
        ['Czeck Republic', 49.817492, 15.472962]
    ...
    function addLocationToLocationList(locationList, location) {
        ...
        separatorElement = $('<i/>', { 'class': 'icon-heart' });
